...
function FeatureCard({ icon = <Activity className="h-6 w-6 text-indigo-400" />, title = "Features", description = "Comprehensive reports and analytics to track your service performance." }) {
  return (
...
function PricingCard({ title = "Starter", price = "29", features = [], featured = false }) {
  return (
